	...
	internal class DhtRouting
	{
		...
		internal void SecondTimer()
		{
            if (Core.TimeNow > NextSelfSearch)
			{
                ...
                Network.Searches.Start(Core.LocalDhtID + 1, "Self", ComponentID.Node, null, new EndSearchHandler(EndSelfSearch));
                ...
                Core.TimeNow > bucket.NextRefresh)
			{
                ...
                Network.Searches.Start(bucket.GetRandomBucketID(), "Low Bucket", ComponentID.Node, null, null);
