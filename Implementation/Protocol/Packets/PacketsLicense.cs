...
namespace DeOps.Implementation.Protocol.Packets
{
    ...
    {
        internal const byte Full = 0x10;
        internal const byte Light = 0x20;
    }

    internal class FullLicense : G2Packet
    {
...
#if DEBUG
        internal void Sign(G2Protocol protocol, RSACryptoServiceProvider JMG_KEY)
        {
        ...
        internal static FullLicense Decode(G2Header root)
        {
            // public key
    ...
    internal class LightLicense : G2Packet
    {
        const byte Packet_Signature = 0x10;
        ...
        internal LightLicense() { }

        internal LightLicense(FullLicense full) 
        {
            Name = full.Name;
        ...
        internal static LightLicense Decode(byte[] data)
        {
        ...
        internal static LightLicense Decode(G2Header root)
        {
            // public key
            RSACryptoServiceProvider JMG_KEY = new RSACryptoServiceProvider();
            JMG_KEY.FromXmlString("<RSAKeyValue><Modulus>tE2IUcTiZLCWvg7FwRdw9b12PvOJscfIM9wFMEByN8D+cKbtYI7YHdNFWN4rt0ZRrlcT/V07WhdNajSMgte2kBxqoL7rZ4vJ9fkL5xQrgSwaX80EGQIyyVGL1Y0W06AcJtIlH1VRok0SeVXr6NCE+HEVjRQmn3Npo9qCLzPeUzk=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>");
