...
namespace DeOps.Implementation
{
    ...
    public delegate void ProcessTagsHandler(PacketStream stream);

    public class IVCryptoStream : CryptoStream
    {
        ...
        public static IVCryptoStream Load(string path, byte[] key)
        {
        ...
        public static IVCryptoStream Load(Stream stream, byte[] key)
        {
        ...
        public static IVCryptoStream Save(string path, byte[] key)
        {
    ...
    public class TaggedStream : FileStream
    {
        long InternalSize;
