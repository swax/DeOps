...
{
    public delegate byte[] GetLocalSyncTagHandler();
    public delegate void LocalSyncTagReceivedHandler(ulong user, byte[] tag);
    ...
    public class LocalSync : OpService
    {
        ...
        public Dictionary<ulong, ServiceData> InRange = new Dictionary<ulong, ServiceData>();
        public Dictionary<ulong, ServiceData> OutofRange = new Dictionary<ulong, ServiceData>();

        public ServiceEvent<GetLocalSyncTagHandler> GetTag = new ServiceEvent<GetLocalSyncTagHandler>();
        public ServiceEvent<LocalSyncTagReceivedHandler> TagReceived = new ServiceEvent<LocalSyncTagReceivedHandler>();
    ...
    {
        public const byte ServiceData = 0x10;
    }

    public class ServiceData : G2Packet
    {
