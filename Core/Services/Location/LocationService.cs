...
{
    public delegate void LocationUpdateHandler(LocationData location);
    public delegate void LocationGuiUpdateHandler(ulong key);
    public delegate void KnowOnlineHandler(List<ulong> users);

    public delegate byte[] GetLocationTagHandler();
    public delegate void LocationTagReceivedHandler(DhtAddress address, ulong user, byte[] tag);
    ...
    public class LocationService : OpService
    {
        ...
        public uint LocationVersion = 1;
        public DateTime NextGlobalPublish;

        public ClientInfo LocalClient;
        public ThreadedDictionary<ulong, ClientInfo> Clients = new ThreadedDictionary<ulong, ClientInfo>();

        Dictionary<ulong, DateTime> NextResearch = new Dictionary<ulong, DateTime>();

        public LocationUpdateHandler LocationUpdate;
        public LocationGuiUpdateHandler GuiUpdate;

        public KnowOnlineHandler KnowOnline;
        ...
        public ServiceEvent<GetLocationTagHandler> GetTag = new ServiceEvent<GetLocationTagHandler>();
        public ServiceEvent<LocationTagReceivedHandler> TagReceived = new ServiceEvent<LocationTagReceivedHandler>();

        int PruneLocations = 64;
        int MaxClientsperUser = 10;
        public bool LocalAway;


        public LocationService(OpCore core)
        {
            Core = core;
        ...
        public void AddRoutingData(LocationData location) // a light loc can also be used here
        {
        ...
        public ClientInfo GetLocationInfo(ulong user, ushort client)
        {
        ...
        public string GetLocationName(ulong user, ushort client)
        {
        ...
        public void Research(ulong user)
        {
        ...
        public int ActiveClientCount(ulong user)
        {
            int count = 0;
        ...
        public List<ClientInfo> GetClients(ulong user)
        {
        ...
        public void SetInvisble(bool mode)
        {
        ...
        public void SetAway(bool mode, string msg)
        {
            if (LocalAway == mode)
                return;
    ...
    public class ClientInfo : DhtClient
    {
        public LocationData Data;
        public byte[] SignedData;

        public DateTime NextPing; // next time a ping can be sent
        public DateTime LastSeen; // last time pong was received
        ...
        public ClientInfo() { } // used only for InternalData debugging
