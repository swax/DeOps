...
namespace DeOps.Services
{
    ...
    public class MenuItemInfo
    {
        ...
        public MenuItemInfo(string path, Icon symbol, EventHandler onClick)
        {
            Path = path;
        ...
        public MenuItemInfo(string path, Image symbol, EventHandler onClick)
        {
            Path = path;
            Symbol = symbol;
            ClickEvent = onClick;
    ...
    {
        public const byte SignedData = 0x10;
        public const byte VersionedFile = 0x20;
    }

    public class SignedData : G2Packet
    {
