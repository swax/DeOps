...
{
    public delegate void ProfileUpdateHandler(OpProfile profile);


    public class ProfileService : OpService
    {
        ...
        public OpProfile LocalProfile;
        public ThreadedDictionary<ulong, OpProfile> ProfileMap = new ThreadedDictionary<ulong, OpProfile>();
        
        public ProfileUpdateHandler ProfileUpdate;
        ...
        public string GetFilePath(OpProfile profile)
        {
    ...
    public class OpProfile
    {
        ...
        public List<ProfileAttachment> Attached = new List<ProfileAttachment>();
