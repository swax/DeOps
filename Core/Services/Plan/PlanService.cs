...
{
    public delegate void PlanUpdateHandler(OpPlan plan);


    public class PlanService : OpService
    {
        ...
        public OpPlan LocalPlan;

        int RunSaveLocal;
        int SaveInterval = 60*10; // 10 min stagger, prevent cascade up

        public ThreadedDictionary<ulong, OpPlan> PlanMap = new ThreadedDictionary<ulong, OpPlan>();

        public event PlanUpdateHandler PlanUpdate;
    ...
    public class OpPlan
    {
        ...
        public bool Loaded; // true if blocks/goals loaded

        public Dictionary<uint, List<PlanBlock>> Blocks = null;

        public Dictionary<int, List<PlanGoal>> GoalMap = null;
        public Dictionary<int, List<PlanItem>> ItemMap = null;
