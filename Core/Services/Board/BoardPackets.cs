...
namespace DeOps.Services.Board
{
    public class BoardPacket
    {
        ...
        public const byte PostFile = 0x30;
    }

    public class PostHeader : G2Packet
    {
    ...
    public class PostInfo : G2Packet
    {
        ...
        public PostInfo(string subject, TextFormat format, string quip, Random gen)
        {
            Subject = subject;
            Quip = quip;
            Unique = gen.Next();
    ...
    public class PostFile : G2Packet
    {
        ...
        public PostFile(string name, long size)
        {
            Name = name;
            Size = size;
        }
