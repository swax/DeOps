...
{
    public delegate void LinkUpdateHandler(OpTrust trust);
    public delegate void LinkGuiUpdateHandler(ulong key);


    public class TrustService : OpService
    {
        ...
        public OpTrust LocalTrust;

        public ThreadedDictionary<ulong, OpTrust> TrustMap = new ThreadedDictionary<ulong, OpTrust>();
        public ThreadedDictionary<uint, string> ProjectNames = new ThreadedDictionary<uint, string>();
        public ThreadedDictionary<uint, ThreadedList<OpLink>> ProjectRoots = new ThreadedDictionary<uint, ThreadedList<OpLink>>();
        ...
        public LinkUpdateHandler LinkUpdate;
        public LinkGuiUpdateHandler GuiUpdate;
        ...
        public void LinkupTo(ulong user, uint project)
        {
        ...
        public void AcceptTrust(ulong user, uint project)
        {
            try
            {
        ...
        public void UnlinkFrom(ulong user, uint project)
        {
            try
            {
                bool unlinkUp = false;
        ...
        public void Research(ulong key, uint project, bool searchDownlinks)
        {
            if (Core.InvokeRequired)
            {
        ...
        public bool IsInheritNode(ulong check)
        {
        ...
        public void JoinProject(uint project)
        {
            if (Core.InvokeRequired)
            {
        ...
        public void LeaveProject(uint project)
        {
            if (project == 0)
                return;
        ...
        public void RenameProject(uint project, string name)
        {
            if (Core.InvokeRequired)
            {
        ...
        public string GetProjectName(uint id)
        {
            if (id == 0)
        ...
        public void GetLocs(ulong id, uint project, int up, int depth, List<LocationData> locations)
        {
        ...
        public void GetLocsBelow(ulong id, uint project, List<LocationData> locations)
        {
            GetLocsBelow(id, id, project, locations);
        }

        public void GetLocsBelow(ulong id, ulong root, uint project, List<LocationData> locations)    
        {
        ...
        public List<LocationData> GetLocsAbove()
        {
            List<LocationData> locations = new List<LocationData>();
        ...
        public bool IsHigher(ulong key, uint project)
        {
            return IsHigher(Core.UserID, key, project, true);
        }

        public bool IsUnconfirmedHigher(ulong key, uint project)
        {
            return IsHigher(Core.UserID, key, project, false);
        }

        public bool IsHigher(ulong localID, ulong key, uint project)
        {
            return IsHigher(localID, key, project, true);
        }

        public bool IsUnconfirmedHigher(ulong localID, ulong key, uint project)
        {
        ...
        public bool IsLower(ulong localID, ulong lowerID, uint project)
        {
        ...
        public List<ulong> GetUplinkIDs(ulong id, uint project)
        {
            return GetUplinkIDs(id, project, true, false);
        }

        public List<ulong> GetUnconfirmedUplinkIDs(ulong id, uint project)
        {
        ...
        public List<ulong> GetAutoInheritIDs(ulong local, uint project)
        {
        ...
        public List<ulong> GetAdjacentIDs(ulong id, uint project)
        {
            List<ulong> list = new List<ulong>();
        ...
        public List<ulong> GetDownlinkIDs(ulong id, uint project, int levels)
        {
            List<ulong> list = new List<ulong>();
        ...
        public bool HasSubs(ulong id, uint project)
        {
            int count = 0;
        ...
        public bool IsAdjacent(ulong id, uint project)
        {
        ...
        public bool IsLowerDirect(ulong id, uint project)
        {
            OpLink link = LocalTrust.GetLink(project);
        ...
        public bool IsHigherDirect(ulong id, uint project)
        {
            OpLink link = LocalTrust.GetLink(project);
        ...
        public bool IsInScope(Dictionary<ulong, short> scope, ulong testID, uint project)
        {
        ...
        public OpTrust GetTrust(ulong id)
        {
            return GetTrust(id, true);
        }

        public OpLink GetLink(ulong id, uint project)
        {
        ...
        public void SetTitle(ulong user, uint project, string title)
        {
    ...
    public class OpTrust
    {
        ...
        public bool InLocalLinkTree;
        public bool PingUser;
        public bool Searched;

        public Dictionary<uint, OpLink> Links = new Dictionary<uint, OpLink>();

        public OpVersionedFile File;


        public OpTrust(OpVersionedFile file)
        {
            File = file;
        }
        ...
        public OpTrust(uint project, ulong loopID)
        {
            Loaded = true;
            Name = "Trust Loop";
            LoopID = loopID;
        ...
        public bool InProject(uint project)
        {
        ...
        public void RemoveProject(uint project)
        {
            OpLink link = GetLink(project);
        ...
        public OpLink GetLink(uint project)
        {
            OpLink link = null;
        ...
        public void CheckRequestVersions()
        {
    ...
    public class OpLink
    {
        ...
        public OpLink LoopRoot;
        public bool InLoop { get { return LoopRoot != null; } }

        public OpLink Uplink;
        public List<OpLink> Downlinks = new List<OpLink>();
        public List<ulong> Confirmed = new List<ulong>();
        public List<UplinkRequest> Requests = new List<UplinkRequest>();
        ...
        public OpLink GetHigher(bool confirmed)
        {
            if (Uplink == null)
                return null;
        ...
        public List<OpLink> GetLowers(bool confirmed)
        {
