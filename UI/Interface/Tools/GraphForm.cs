...
namespace DeOps.Interface.Tools
{
	...
	/// </summary>
    public class GraphForm : DeOps.Interface.CustomIconForm
	{
		/// <summary>
		...
		public delegate void UpdateGraphHandler();
		public UpdateGraphHandler UpdateGraph;
        ...
        public GraphForm(DhtNetwork network)
		{
			//
