...
{
	public enum CrawlStatus {Active, Paused};

	/// <summary>
	/// Summary description for CrawlerForm.
	/// </summary>
    public class CrawlerForm : DeOps.Interface.CustomIconForm
	{
        OpCore Core;
		DhtNetwork Network;
		DhtRouting Routing;
		...
		public delegate void SearchAckHandler(SearchAck ack, G2ReceivedPacket packet);
		public SearchAckHandler SearchAck;

		public delegate void CrawlAckHandler(CrawlAck ack, G2ReceivedPacket packet);
		public CrawlAckHandler CrawlAck;
        ...
        public CrawlerForm(DhtNetwork network)
		{
			//
	...
	public class CrawlNode
	{
		...
		public CrawlAck  Ack;
		public int	   Attempts;
		public DateTime  NextTry = new DateTime(0);

		public CrawlNode Proxy;
        public bool OpenConnection { get { return Proxy == null; } }
