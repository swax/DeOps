...
namespace DeOps.Interface
{
    public partial class TextInput : UserControl
    {
        ...
        public TextFormat TextFormat = TextFormat.RTF;

        public delegate void SendMessageHandler(string message, TextFormat format);
        public SendMessageHandler SendMessage;

        public MethodInvoker SendFile;
        public MethodInvoker IgnoreUser;
        public MethodInvoker AddBuddy;
