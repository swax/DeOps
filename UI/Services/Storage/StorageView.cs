...
{
    public partial class StorageView : ViewShell
    {
        public CoreUI UI;
        public OpCore Core;
        ...
        public Font RegularFont = new Font("Tahoma", 8.25F);
        public Font BoldFont = new Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));

        public List<ulong> HigherIDs = new List<ulong>();
        public List<ulong> CurrentDiffs = new List<ulong>();
        public List<ulong> FailedDiffs = new List<ulong>();

        public Dictionary<ulong, int> ChangeCount = new Dictionary<ulong, int>();

        Dictionary<ulong, RescanFolder> RescanFolderMap = new Dictionary<ulong, RescanFolder>();
        int NextRescan;

        public bool WatchTransfers;
        ...
        public FolderNode GetFolderNode(string path)
        {
            // path: \a\b\c
    ...
    public class FolderNode : TreeListNode 
    {
        public bool Temp;
        public StorageFolder Details;
        StorageView View;
        ...
        public Dictionary<ulong, StorageItem> Changes = new Dictionary<ulong, StorageItem>();

        public Dictionary<ulong, FolderNode> Folders = new Dictionary<ulong, FolderNode>();
        public Dictionary<ulong, FileItem> Files = new Dictionary<ulong, FileItem>();

        public bool ContainsHigherChanges;
        public bool ContainsLowerChanges;
        ...
        public Dictionary<ulong, StorageItem> GetRealChanges()
        {
        ...
        public bool ParentPathContains(ulong uid)
        {
            if (Details.UID == uid)
                return true;
    ...
    public class FileItem : ContainerListViewItem
    {
        public StorageItem Details;
        StorageView View;
        ...
        public Dictionary<ulong, StorageItem> GetRealIntegrated()
        {
