...
{
    public partial class LockMessage : DeOps.Interface.CustomIconForm
    {
        LockErrorType Type;
        List<LockError> Errors;

        public List<LockError> NewErrors = new List<LockError>();
    ...
    public class ErrorItem : ContainerListViewItem
    {
        public LockError Error;
