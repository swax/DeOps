...
namespace DeOps.Services.Storage
{
    public partial class InfoPanel : UserControl
    {
        ...
        public string CurrentWebSource = "";
        ...
        public bool DiffsView;

        public Dictionary<ulong, StorageItem> CurrentChanges = new Dictionary<ulong, StorageItem>();
        public Dictionary<ulong, StorageItem> CurrentIntegrated = new Dictionary<ulong, StorageItem>();
        ...
        public void Init(StorageView parent)
        {
            ParentView = parent;
        ...
        public void ShowItem(FolderNode folder, FileItem file)
        {
        ...
        public List<ChangeRow> SortChanges(Dictionary<ulong, StorageItem> changes)
        {
            ...
            {
                string name = ParentView.Core.GetName(item.Key);
        ...
        private void GetDifferenceRows(StringBuilder html)
        {
            ...
            foreach (ulong id in ParentView.CurrentDiffs)
            {
                ...
                html.Replace("<?=name?>", ParentView.Core.GetName(id));
        ...
        public void UpdateDiffView(ulong id)
        {
    ...
    public class ChangeRow : IComparable<ChangeRow>
    {
        public ulong ID;
        public string Name;
        ...
        public ChangeRow(ulong id, string name, StorageItem item, bool higher)
        {
            ID = id;
            Name = name;
            Item = item;
