...
namespace DeOps.Services.Trust
{
    public class LinkTree : TreeListViewEx 
    {
        ...
        public ProjectNode UnlinkedNode;


        Dictionary<ulong, LinkNode> NodeMap = new Dictionary<ulong, LinkNode>();

        public ulong SelectedLink;
        public uint SelectedProject;

        public ulong ForceRootID;
        public bool HideUnlinked;
        ...
        public Font SelectedFont = new System.Drawing.Font("Tahoma", 8.25F, FontStyle.Bold);
        ...
        public void SelectLink(ulong id, uint project)
        {
    ...
    public class LabelNode : TreeListNode
    {
    ...
    public class ProjectNode : TreeListNode
    {
        public uint ID;

        public ProjectNode(string text, uint id)
        {
            Text = text;
            ID = id;
        }
    ...
    public class LinkNode : TreeListNode
    {
        public OpLink Link;
        LinkTree ParentView;
        public TrustService Trust;
